...
var widget_slice = Array.prototype.slice
...
var left = (parseInt(that.element.css("left"), 10) +
				(that.position.left - that.originalPosition.left)) || null;

			
var top = (parseInt(that.element.css('top'), 10) +
				(that.position.top - that.originalPosition.top)) || null
...
$.ui.plugin.add('resizable', 'ghost', {
    ...
    start: function () {
		var that = $(this).resizable("instance"); var o = that.options; var cs = that.size
...
var handle = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>";
...
var element = $("<" + nodeName + '>', that.document[0])
    ...
    _contactContainers: function (event) {
      var i; var j; var dist; var itemWithLeastDistance; var posProperty; var sizeProperty; var cur; var nearBottom; var floating; var axis;
...
var scroll = this.cssPosition === "absolute" && !(this.scrollParent[0] !== this.document[0] && $.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent; var scrollIsRootNode = (/(html|body)/i).test(scroll[0].tagName)
