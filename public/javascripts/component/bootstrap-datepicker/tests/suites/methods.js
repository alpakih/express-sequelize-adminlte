...
test('setDate', function () {
  ...
  var expected_date = new Date(Date.UTC(2013, 1, 1))
...
test('setStartDate', function () {
  ...
  var expected_date = new Date(Date.UTC(2012, 3, 5))

  var returnedObject = this.dp.setStartDate(date_in)
  // ...
...
test('setEndDate', function () {
  ...
  var returnedObject = this.dp.setEndDate(date_in)
  // ...
...
test('setDaysOfWeekDisabled - String', function () {
  ...
  var expected_days = [0, 6]

  var returnedObject = this.dp.setDaysOfWeekDisabled(days_in)
  // ...
...
test('moveMonth - can handle invalid date', function () {
  ...
  var returnedObject = this.dp.moveMonth(invalidDate, 1)
  // ...
