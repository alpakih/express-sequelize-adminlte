...
test('"remove" is an alias for "destroy"', function () {
  var called; var originalDestroy = this.dp.destroy
...
test('picker should render fine when `$.fn.show` and `$.fn.hide` are overridden', patch_show_hide(function () {
  ...
  var minViewMode = this.dp.o.minViewMode

  var maxViewMode = this.dp.o.maxViewMode

  var childDivs = this.picker.children('div')
